...
knitr::include_graphics('sistemas.png')
```
...
knitr::include_graphics('ggplotlogo.jpg')
```
...
```{r, echo=FALSE, out.width="25%"}
knitr::include_graphics('ggbook.jpg')
```
...
knitr::include_graphics('gg0.png')
```
...
knitr::include_graphics("gg1.png")
```
...
```{r, echo=F, out.width="60%"}
knitr::include_graphics("gg2.png")
```
...
```{r, echo=F, out.width="60%"}
knitr::include_graphics("gg3.png")
```
...
```{r, echo=F, out.width="60%"}
knitr::include_graphics("gg4.png")
```
...
knitr::include_graphics("points-symbols.jpg")
```
...
#display.brewer.all()
knitr::include_graphics("colores.jpg")
```
...
```{r, echo=F}
knitr::include_graphics("ggpairs1.jpg")
```

```{r, echo=F}
knitr::include_graphics("ggpairs2.jpg")
```

```{r, echo=F}
knitr::include_graphics("ggpairs3.jpg")
```
...
```{r, echo=F}
knitr::include_graphics("ggfortify.jpg")
```
