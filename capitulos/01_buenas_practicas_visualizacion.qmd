...
partos <- read_csv("../data/unidad01/partos_rosario.csv")
...
knitr::include_graphics("../imagenes/unidad01/piyg.png")
```
...
```{r, fig.cap="Fuente: Fundamentals of Data Visualization - Claus Wilke"}
knitr::include_graphics("../imagenes/unidad01/blue-green-cvd-sim-1.png")
```
...
knitr::include_graphics("../imagenes/unidad01/torta3d.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../imagenes/unidad01/barras3d.png")
```
