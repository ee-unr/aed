...
```{r, echo=FALSE}
knitr::include_graphics("../imagenes/unidad02/iniciarRmd.png")
```
...
knitr::include_graphics("../imagenes/unidad02/elformato.png")
```
...
knitr::include_graphics("../imagenes/unidad02/partesRmd.png")
```
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("../imagenes/unidad02/formatotxt.png")
```
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("../imagenes/unidad02/titulos.png")
```
...
knitr::include_graphics("../imagenes/unidad02/botonknitr.png")
```
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("../imagenes/unidad02/listas.png")
```
...
````markdown
`r ''````{r, out.width="50%"}
`r ''`knitr::include_graphics("../imagenes/unidad02/C:/Mis Documentos/messi.jpg")
`r ''````
````

```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("../imagenes/unidad02/messi.jpg")
```
...
```{r, echo = FALSE, out.width="60%"}
knitr::include_graphics("../imagenes/unidad02/tabla1_pdf.png")
```
...
knitr::include_graphics("../imagenes/unidad02/latex.png")
```
...
knitr::include_graphics("../imagenes/unidad02/beamer1.png")
```
...
knitr::include_graphics("../imagenes/unidad02/beamer2.png")
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics("../imagenes/unidad02/proceso.png")
```
